...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo __SITENAME__; ?></title>
        
        <meta name="description" content="Here goes description" />
        <meta name="author" content="author name" />
        <link rel="shortcut icon" href="<?php echo __URL__; ?>/images/favicon.ico" type="image/x-icon" />
        <!-- ======================================================================
    ...
    <body>
    <?php require __ROOT__ . '/views/include/navbar.php'; ?>
